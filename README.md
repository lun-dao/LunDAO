...
LunDAO 是一個鼓勵撰寫與 Ethereum 社群相關的中文文章，透過一個短期的實驗專案嘗試 DAO 可以如何進行社群治理以及回饋社群貢獻。
...
在這樣的背景下，這些中深度的文章其實是有一定的需求，但以目前撰寫的部分有許多都是以無償的形式進行。而另外一件需要考慮的問題是這些撰寫中深度文章的作者，總是會需要從初階的文章開始撰寫，才有機會往下繼續深入。LunDAO 希望透過成立一個實驗性質的短期專案的 DAO 來鼓勵更多作者可以撰寫 Ethereum 相關的中文文章，彌補目前的資源缺口，成立初期希望採用以下主題為目標（但不限於這些主題）：
...
此 DAO 的短期目標是在二年內產生 20-50 篇與 Ethereum 技術相關的中文文章。若行有餘力，長期會用於改善 Ethereum 中文社群資源如辦理小型聚會、製作影片、研討會等。
